...
class User(models.Model):
    ...
    github = models.URLField(max_length=300, unique=True, null=True, blank=True)
    linkedin = models.URLField(max_length=300, unique=True, null=True, blank=True)
    mastercv = models.URLField(max_length=300, unique=True, null=True, blank=True)
    resume1 = models.URLField(max_length=300, unique=True, null=True, blank=True)
